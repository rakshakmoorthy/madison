<!--
    00-frontmatter.md
    FRONT MATTER — pre-body (roman-numeral / unnumbered in print).
    Sections in order: Title page, Copyright, Dedication, Preface.
...
*For the brand person who still checks the claim before it ships.*
...
This book is not a comprehensive manual for every AI system, a replacement for disciplinary training in marketing, or a promise that the hard parts of brand-building disappear. It does not teach you to draw a logo or to run a media buy. It teaches the judgment that decides whether a fluent artifact is one you should put your name and your brand behind.
