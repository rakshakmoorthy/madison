# Chapter Research Notes: Measurement Plan and KPI Map

Generated: 2026-06-14

Corresponding proposed chapter: `chapters/08-measurement-plan-and-kpi-map.md`
...
**Current Madison state:** The repo's research report identifies measurement and reporting as high-value recipe territory. Madison already has performance and survey recipes that can anchor the chapter.

**Teaching considerations:** Require a 'what decision will this metric change?' field. It prevents vanity metrics from passing as KPIs.
