# Chapter Research Notes: Content Calendar With Provenance

Generated: 2026-06-14

Corresponding proposed chapter: `chapters/11-content-calendar-with-provenance.md`
...
**Current Madison state:** Madison has a content-agent recipe, alert logs, and platform exercises. The missing chapter should impose the book's evidence and approval structure on calendar planning.

**Teaching considerations:** Use a table format. Students should learn that every content row has operational obligations, not just a caption.
