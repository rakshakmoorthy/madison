# Chapter Research Notes: Audience Persona Evidence Synthesis

Generated: 2026-06-14

Corresponding proposed chapter: `chapters/10-audience-persona-evidence-synthesis.md`
...
**Current Madison state:** The repo has audience-definition and persona-generation recipes plus branding chapters on strategy paths. The new chapter should put those pieces under one evidence discipline.

**Teaching considerations:** Make readers delete every persona sentence that lacks a source or an inference label. This is where the chapter earns trust.
