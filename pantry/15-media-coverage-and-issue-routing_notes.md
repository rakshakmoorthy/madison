# Chapter Research Notes: Media Coverage and Issue Routing

Generated: 2026-06-14

Corresponding proposed chapter: `chapters/15-media-coverage-and-issue-routing.md`
...
**Current Madison state:** Madison has several reputation, sentiment, news, and RSS recipes. The missing chapter should convert them into a practical public-signal workflow for brand teams.

**Teaching considerations:** Use examples where the correct action is 'route and wait' rather than 'generate a reply'. That is the governance lesson.
