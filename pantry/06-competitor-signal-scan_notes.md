# Chapter Research Notes: Competitor Signal Scan

Generated: 2026-06-14

Corresponding proposed chapter: `chapters/06-competitor-signal-scan.md`
...
**Current Madison state:** The repo has several competitor and market intelligence recipes, but the chapter should standardize the entry-level workflow into a teachable signal scan with provenance.

**Teaching considerations:** Force the reader to separate source capture, observation, interpretation, and recommendation into different columns.
