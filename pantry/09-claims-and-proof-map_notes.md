# Chapter Research Notes: Claims and Proof Map

Generated: 2026-06-14

Corresponding proposed chapter: `chapters/09-claims-and-proof-map.md`
...
**Current Madison state:** Madison already has copy, review, cleanup, and provenance prompt infrastructure. The missing chapter should combine them into a compact claims/proof workflow.

**Teaching considerations:** Use line-by-line annotation. Students should see how a single confident adjective can change the proof burden.
