# Chapter Research Notes: Verifying Brand Evidence

Generated: 2026-06-14

Corresponding proposed chapter: `chapters/05-verifying-brand-evidence.md`
...
**Current Madison state:** Madison's repo has evidence discipline in docs, prompts, templates, and exercises. The missing chapter should turn those rules into a repeatable practitioner checklist.

**Teaching considerations:** Use messy evidence. Clean examples make verification feel ceremonial; imperfect evidence teaches judgment.
