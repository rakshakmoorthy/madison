# Chapter Research Notes: The Creative Brief Builder

Generated: 2026-06-14

Corresponding proposed chapter: `chapters/07-the-creative-brief-builder.md`
...
**Current Madison state:** The existing Madison exercises and prompt suites already teach brief-like thinking; the new chapter should narrow that material into a practitioner recipe.

**Teaching considerations:** Grade the assumption register as seriously as the brief. The point is not just a better brief, but a brief that knows what it does not know.
