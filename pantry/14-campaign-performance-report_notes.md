# Chapter Research Notes: Campaign Performance Report

Generated: 2026-06-14

Corresponding proposed chapter: `chapters/14-campaign-performance-report.md`
...
**Current Madison state:** Madison already contains performance, survey, and intelligence recipes plus logs. The missing chapter should define the reporting template and anti-overclaiming rules.

**Teaching considerations:** Ask readers to write one 'what changed because of this report?' sentence. If the sentence is vague, the report is not finished.
