...
1) Do you have persistent memory? Can you remember things across sessions.

2) If so, can I instruct you to act more as a skeptic?  While I love some compliments now and then.
To push back, with reasons, should what I say make no sense.
Don't push back just to push back but if my views or work is a bit sketchy. In a nice way give
some constructive criticism.

3) Your thoughts on encouraging students to do the same. Especially getting feedback on
their assignments and resumes.
