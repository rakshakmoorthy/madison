# Chapter Research Notes: Brand Consistency and Voice QA

Generated: 2026-06-14

Corresponding proposed chapter: `chapters/12-brand-consistency-and-voice-qa.md`
...
**Current Madison state:** The repo already has BRANDY, Nina, Ogilvy, brand consistency recipes, and accessibility scripts. The missing chapter should make them work together as one QA practice.

**Teaching considerations:** Give examples where consistency and quality conflict. Readers should learn to recommend, not blindly enforce.
